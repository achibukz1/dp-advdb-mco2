...
# ============================================================================
    ...
    scenario_queries = {
        "Same Account Transactions": "SELECT * FROM trans WHERE account_id = 1 LIMIT 50",
        "Credit Transactions": "SELECT * FROM trans WHERE type = 'Credit' LIMIT 100",
        "Date Range Query": "SELECT * FROM trans WHERE newdate BETWEEN '1995-01-01' AND '1995-12-31' LIMIT 100",
        "Account Analytics": "SELECT account_id, COUNT(*) as trans_count, SUM(amount) as total_amount FROM trans GROUP BY account_id LIMIT 20",
        "High-Value Transactions": "SELECT * FROM trans WHERE amount > 10000 ORDER BY amount DESC LIMIT 50"
    }
